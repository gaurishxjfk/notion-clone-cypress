...
import Logo from "../../../public/BannerImage.png";
...
// TODO
// when deleting folder ..delete its files too
  ...
  useEffect(() => {
    ...
    const fetchInformation = async () => {
      if (dirType === "file") {
        ...
        quill.setContents(JSON.parse(selectedDir[0].data || "ababdjsa"));
        dispatch({
          type: "UPDATE_FILE",
          payload: {
        ...
        <div className="w-full self-center max-w-[800px] flex  flex-col px-7  lg:my-8">
          <div className="text-[80px]">
            <EmojiPicker getValue={iconOnChange}>
              <div className="w-[100px]  cursor-pointer transition-colors h-[100px] flex items-center justify-center rounded-xl">
                {details.iconId}
              </div>
            </EmojiPicker>
          </div>
